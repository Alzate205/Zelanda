...
function aniosDesde(fecha: Date): {
  ...
  let display: string;
  if (dias < 30) display = `${dias} d`;
  else if (anios < 2) display = `${meses} m`;
  else if (mesesRestantes > 0) display = `${anios}a ${mesesRestantes}m`;
  else display = `${anios}a`;
    ...
    <div className="-mx-4 -mt-4">
      ...
      <div className="space-y-5 px-4 pt-5">
        <Link
          ...
          className="flex min-h-touch items-center justify-center gap-2 rounded-xl border border-zelanda-ocre-300 bg-zelanda-ocre-50 px-4 font-semibold text-zelanda-ocre-700 transition hover:bg-zelanda-ocre-100"
        >
        ...
        {conteoArr.length > 0 ? (
          <section>
            <Eyebrow>Intervenciones acumuladas</Eyebrow>
        ...
        {registros.length > 0 ? (
          <section>
            <Eyebrow>Historial · {registros.length} registros</Eyebrow>
              ...
              {registros.map((r) => (
                ...
                >
                  <div className="flex flex-wrap items-baseline justify-between gap-2">
                    <p className="font-serif text-[14px] text-zelanda-verde-900">
                      {r.tipo_tarea_nombre}
                    </p>
                  ...
                  {r.observaciones ? (
                    <p className="mt-1.5 whitespace-pre-wrap text-[12px] text-zelanda-verde-800">
                      {r.observaciones}
                    </p>
                  ) : null}
                </li>
        ...
        {novedades.length > 0 ? (
          <section>
            <Eyebrow>Novedades · {novedades.length}</Eyebrow>
