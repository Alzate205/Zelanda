...
ALTER TABLE despacho_items
  ADD COLUMN IF NOT EXISTS costo_unitario_snapshot NUMERIC(12,2) NULL;

CREATE INDEX IF NOT EXISTS idx_despachos_lote ON despachos(lote_id) WHERE lote_id IS NOT NULL;
