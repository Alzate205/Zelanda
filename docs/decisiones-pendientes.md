...
**Decisión:** Eliminado. No hay sub-rol APICULTOR; las tareas de apicultura se asignan a cualquier trabajador disponible.
**Aplicado:** CLAUDE.md §4.4 (nota) y §5.5 ya lo reflejan ("No hay sub-rol 'apicultor'"). `es_apicultor` no existe en el schema/Prisma ni en el código — solo quedan menciones en los specs/planes históricos del 2026-05-11, que se dejan como registro.
